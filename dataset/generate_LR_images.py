...
@click.option(
    "--save_folder",
    default="/media/danil/Data/Experiments/ESRGAN/data/DIV2K_train_HR_sub_bicLRx",
...
def main(input_folder, save_folder):
    ...
    for path in img_list:
        pool.apply_async(
            worker, args=(path, save_folder, compression_level), callback=update
        )
    pool.close()
    pool.join()
